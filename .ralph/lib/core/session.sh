...
write_summary_header() {
  {
    ...
    echo "| source_control_enabled | ${RALPH_SOURCE_CONTROL_ENABLED} |"
    echo "| source_control_backend | ${RALPH_SOURCE_CONTROL_BACKEND} |"
    echo "| source_control_allow_commits | ${RALPH_SOURCE_CONTROL_ALLOW_COMMITS} |"
    echo "| source_control_branch_per_session | ${RALPH_SOURCE_CONTROL_BRANCH_PER_SESSION} |"
    echo "| source_control_branch_name_template | ${RALPH_SOURCE_CONTROL_BRANCH_NAME_TEMPLATE} |"
    echo "| source_control_require_ticket_for_branch | ${RALPH_SOURCE_CONTROL_REQUIRE_TICKET_FOR_BRANCH} |"
